 ...
 */
@JacksonComponent
public class DefaultCryptoJsonConverter5 {

    private final CryptoService cryptoService;

    public DefaultCryptoJsonConverter5(CryptoService cryptoService) {
     ...
     * @author Florian Lestic
     */
    public class DefaultCryptoJsonSerializer extends BaseCryptoJsonSerializer<Void> {
     ...
     * @author Florian Lestic
     */
    public class DefaultCryptoJsonDeserializer extends BaseCryptoJsonDeserializer<Void> {
